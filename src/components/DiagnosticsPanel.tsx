import { Battery, Gauge, Activity, AlertTriangle, Zap, TrendingUp } from 'lucide-react';
        ...
        <AnimatePresence>
          {sensorData && (
            <motion.div
              ...
              exit={{ opacity: 0, x: -20 }}
              className="mb-6 inline-flex items-center gap-3 px-5 py-2.5 bg-gradient-to-r from-emerald-500/20 to-green-500/20 backdrop-blur-xl rounded-full border border-emerald-400/30"
            ...
            >
              ...
              />
              <span className="text-sm font-bold text-emerald-300 tracking-wider">LIVE DATA CONNECTED</span>
            </motion.div>
          )}
        </AnimatePresence>
